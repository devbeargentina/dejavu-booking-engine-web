...
const DetailsMainAttractions = (props) => {
  const sccs = `
  .map-icon {
    position: absolute;
    top: 50%;
    ...
    <div className="details-itinerary">
      ...
      <div className="row">
        <div className="col-lg-10 d-flex">
          <p className="cls">{ReactHtmlParser(decode(props.mainAttraction))}</p>
          <img
            style={{ width: "360px", height: "200px", float: "left" }}
            className="mr-3"
            src={Iti}
            alt=""
          />
...
export default DetailsMainAttractions;
