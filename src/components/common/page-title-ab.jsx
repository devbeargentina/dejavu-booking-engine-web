...
const PageTitleAB = (props) => {
  return (
    <div className="page-header-title-bg page-header-title-be page-header-title-ab">
      <div className="container">
        <div>
          ...
          &nbsp;
          <h1>{props && props.message ? props.message : "Thank You"}</h1>
        </div>
      </div>
    </div>
  );
