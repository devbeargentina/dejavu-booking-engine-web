...
import DetailsMainAttractions from "../components/booking/details/details-main-attractions";
import DetailsPriceGuideLine from "../components/booking/details/details-price-guidlines";
import DetailsTermsConditions from "../components/booking/details/details-terms-conditions";
        ...
        <>
          <div className="details-page">
            ...
            <div className="container ">
              <div className="row">
                <div className="col-lg-12 mt-4">
                  <DetailsMainAttractions {...packageInfo} />
                </div>
              </div>
            </div>
            <div className="container ">
            ...
            <div className="container ">
              <div className="row">
                <div className="col-lg-12 mt-4">
                  <DetailsPriceGuideLine {...packageInfo} />
                </div>
              </div>
            </div>
            <div className="container ">
              <div className="row">
                <div className="col-lg-12 mt-4">
                  <DetailsTermsConditions {...packageInfo} />
                </div>
              </div>
            </div>
            <div className="container ">
